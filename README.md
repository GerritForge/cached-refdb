...
NOTE: As this RefDatabase implements an extremely efficient objectId -> ref lookup, you must
disable Gerrit's default, inefficient, implementation to take advantage of it.
You can do this by setting `receive.enableInMemoryRefCache = false` in your gerrit.config
