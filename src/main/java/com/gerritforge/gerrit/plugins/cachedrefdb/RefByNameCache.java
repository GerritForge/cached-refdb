...
interface RefByNameCache {
  ...
  void updateRefInPrefixesByProjectCache(String identifier, Ref ref);

  void updateRefInPrefixesByProjectCache(String identifier, String refName, RefDatabase delegate);

  void deleteRefInPrefixesByProjectCache(String identifier, String refName);

  Set<String> getRefNamesByObjectId(String identifier, ObjectId id, RefDatabase delegate)
      throws IOException;
