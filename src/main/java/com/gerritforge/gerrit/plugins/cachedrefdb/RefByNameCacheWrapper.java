...
class RefByNameCacheWrapper implements RefByNameCache {
  ...
  @Override
  public void updateRefNamesByProjectCache(String identifier, Ref ref) {
    cache.updateRefNamesByProjectCache(identifier, ref);
  }

  @Override
  public void updateRefNamesByProjectCache(
      String identifier, String refName, RefDatabase delegate) {
    cache.updateRefNamesByProjectCache(identifier, refName, delegate);
  }
