...
class RefsByObjectIdCacheImpl implements RefsByObjectIdCache {
    ...
    static com.google.inject.Module module() {
        return new CacheModule() {
            ...
            protected void configure() {
                cache(REFS_BY_OBJECT_ID, ObjectId.class, new TypeLiteral<Set<Ref>>() {}).loader(RefByObjectIdLoader.class);
            }
        };
    }
    ...
    @Inject
    RefsByObjectIdCacheImpl(@Named(REFS_BY_OBJECT_ID) LoadingCache<ObjectId, Set<Ref>> refsByObjectId) {
