...
class PerThreadRefByNameCache implements RefByNameCache {
  ...
  private final Map<String, Optional<Ref>> refByName;

  private PerThreadRefByNameCache() {
    refByName = new HashMap<>();
  }

  static RefByNameCache get(@Nonnull PerThreadCache perThreadCache) {
